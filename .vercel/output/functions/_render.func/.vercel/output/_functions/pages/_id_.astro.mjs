import {
  ...
  a as addAttribute,
  u as unescapeHTML,
} from "../chunks/astro/server_M0d2d5zE.mjs";
import "kleur/colors";
import { $ as $$Layout } from "../chunks/Layout_Dcd0f0gC.mjs";
/* empty css                                */
...
async function getStaticPaths() {
  const response = await fetch(
    "https://public-api.wordpress.com/wp/v2/sites/wincblogs.wordpress.com/posts"
  );
  ...
  async ($$result, $$props, $$slots) => {
    ...
    async function getCategoryName(categoryId2) {
      const response2 = await fetch(
        `https://public-api.wordpress.com/wp/v2/sites/wincblogs.wordpress.com/categories/${categoryId2}`
      );
    ...
    const response = await fetch(
      `https://public-api.wordpress.com/wp/v2/sites/wincblogs.wordpress.com/posts/${postId}`
    );
