...
import { $ as $$Layout } from './Layout_Dcd0f0gC.mjs';
...
const fetchAllArticles = async (user, token) => {
  ...
  if (!response.ok) {
    ...
    articles = (await response.json()).map((res) => ({
      user,
      title: res.title,
...
Detail
</a> </div> <h1 data-astro-cid-4yqtncfb>Articles</h1> <!-- <div class="articles-container">
          ...
          </div> --> ${renderComponent($$result2, "ArticleList", ArticleList, { "client:load": true, "articles": allArticles, "client:component-hydration": "load", "client:component-path": "C:/Users/saeyoshizaki/Desktop/blog_wordpress/src/pages/articles/articles", "client:component-export": "default", "data-astro-cid-4yqtncfb": true })} </div> </div> </body> ` })} `;
}, "C:/Users/saeyoshizaki/Desktop/blog_wordpress/src/pages/articles/article.astro", void 0);
const $$file = "C:/Users/saeyoshizaki/Desktop/blog_wordpress/src/pages/articles/article.astro";
